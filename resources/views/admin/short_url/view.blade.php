                                     ...
                                     <div class="d-sm-flex align-items-center justify-content-between">
                                        ...
                                        @if($admin->role != 1)
                                         <div class="page-title-right add_button">
                                             <a href="{{route('short_url_add')}}"> <button type="button" class="btn btn-success waves-effect waves-light">Add Short Url</button></a>
                                         </div>
                                        @endif
                                     </div>
                                 </div>
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".delete-button", function (e) {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: "{{ url('admin/short_url/delete') }}",
                        type: 'GET',
                        data: { 'id': id },
