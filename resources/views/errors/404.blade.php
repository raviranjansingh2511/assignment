...
<div class="max-w-4xl w-full text-center z-10">
    ...
    <div class="mt-10 space-y-6">
        ...
        <p class="text-xl md:text-2xl text-indigo-100 max-w-3xl mx-auto leading-relaxed font-medium">
            The request you're looking for <span class="text-yellow-300 font-bold">does not exist</span>, 
            has been <span class="text-red-300 font-bold">deleted</span>, or 
            the request has <span class="text-pink-300 font-bold">expired</span>.
        </p>
        <p class="text-lg text-indigo-200 mt-4">
            Don't worry — it happens! Make sure you create request correctly.
        </p>
    </div>

    <!-- Buttons -->
    <div class="mt-12 flex flex-col sm:flex-row gap-6 justify-center items-center">
        <a href="https://pay.locknpay.com/" 
        ...
        {{-- <a href="https://pay.locknpay.com" 
           class="px-12 py-6 border-4 border-white text-white font-bold text-xl rounded-2xl hover:bg-white hover:text-indigo-600 transition-all duration-300 backdrop-blur-sm">
            Create New Deposit
        </a> --}}
    </div>
